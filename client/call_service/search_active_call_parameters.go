...
// WithState adds the state to the search active call params
func (o *SearchActiveCallParams) WithState(state []string) *SearchActiveCallParams {
	o.SetState(state)
	return o
}

// SetState adds the state to the search active call params
func (o *SearchActiveCallParams) SetState(state []string) {
	o.State = state
}
...
// bindParamSearchActiveCall binds the parameter state
func (o *SearchActiveCallParams) bindParamState(formats strfmt.Registry) []string {
	stateIR := o.State
