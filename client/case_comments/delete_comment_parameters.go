...
// WithEtag adds the etag to the delete comment params
func (o *DeleteCommentParams) WithEtag(etag string) *DeleteCommentParams {
	o.SetEtag(etag)
	return o
}

// SetEtag adds the etag to the delete comment params
func (o *DeleteCommentParams) SetEtag(etag string) {
	o.Etag = etag
}

// WithFields adds the fields to the delete comment params
func (o *DeleteCommentParams) WithFields(fields []string) *DeleteCommentParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the delete comment params
func (o *DeleteCommentParams) SetFields(fields []string) {
	o.Fields = fields
}
...
// bindParamDeleteComment binds the parameter fields
func (o *DeleteCommentParams) bindParamFields(formats strfmt.Registry) []string {
	fieldsIR := o.Fields
