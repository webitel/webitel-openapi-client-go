...
// WithCaseEtag adds the caseEtag to the delete file params
func (o *DeleteFileParams) WithCaseEtag(caseEtag string) *DeleteFileParams {
	o.SetCaseEtag(caseEtag)
	return o
}

// SetCaseEtag adds the caseEtag to the delete file params
func (o *DeleteFileParams) SetCaseEtag(caseEtag string) {
	o.CaseEtag = caseEtag
}
