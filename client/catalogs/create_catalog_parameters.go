...
type CreateCatalogParams struct {
	...
	// Body.
	Body *models.CasesCreateCatalogRequest
...
func (o *CreateCatalogParams) WithBody(body *models.CasesCreateCatalogRequest) *CreateCatalogParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create catalog params
func (o *CreateCatalogParams) SetBody(body *models.CasesCreateCatalogRequest) {
	o.Body = body
}
