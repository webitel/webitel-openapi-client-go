...
// WithDurationFrom adds the durationFrom to the search attempts history params
func (o *SearchAttemptsHistoryParams) WithDurationFrom(durationFrom *string) *SearchAttemptsHistoryParams {
	o.SetDurationFrom(durationFrom)
	return o
}

// SetDurationFrom adds the durationFrom to the search attempts history params
func (o *SearchAttemptsHistoryParams) SetDurationFrom(durationFrom *string) {
	o.DurationFrom = durationFrom
}

// WithDurationTo adds the durationTo to the search attempts history params
func (o *SearchAttemptsHistoryParams) WithDurationTo(durationTo *string) *SearchAttemptsHistoryParams {
	o.SetDurationTo(durationTo)
	return o
}

// SetDurationTo adds the durationTo to the search attempts history params
func (o *SearchAttemptsHistoryParams) SetDurationTo(durationTo *string) {
...
// WithLeavingAtFrom adds the leavingAtFrom to the search attempts history params
func (o *SearchAttemptsHistoryParams) WithLeavingAtFrom(leavingAtFrom *string) *SearchAttemptsHistoryParams {
	o.SetLeavingAtFrom(leavingAtFrom)
	return o
}

// SetLeavingAtFrom adds the leavingAtFrom to the search attempts history params
func (o *SearchAttemptsHistoryParams) SetLeavingAtFrom(leavingAtFrom *string) {
	o.LeavingAtFrom = leavingAtFrom
}

// WithLeavingAtTo adds the leavingAtTo to the search attempts history params
func (o *SearchAttemptsHistoryParams) WithLeavingAtTo(leavingAtTo *string) *SearchAttemptsHistoryParams {
	o.SetLeavingAtTo(leavingAtTo)
	return o
}

// SetLeavingAtTo adds the leavingAtTo to the search attempts history params
func (o *SearchAttemptsHistoryParams) SetLeavingAtTo(leavingAtTo *string) {
...
// WithOfferingAtFrom adds the offeringAtFrom to the search attempts history params
func (o *SearchAttemptsHistoryParams) WithOfferingAtFrom(offeringAtFrom *string) *SearchAttemptsHistoryParams {
	o.SetOfferingAtFrom(offeringAtFrom)
	return o
}

// SetOfferingAtFrom adds the offeringAtFrom to the search attempts history params
func (o *SearchAttemptsHistoryParams) SetOfferingAtFrom(offeringAtFrom *string) {
	o.OfferingAtFrom = offeringAtFrom
}

// WithOfferingAtTo adds the offeringAtTo to the search attempts history params
func (o *SearchAttemptsHistoryParams) WithOfferingAtTo(offeringAtTo *string) *SearchAttemptsHistoryParams {
	o.SetOfferingAtTo(offeringAtTo)
	return o
}

// SetOfferingAtTo adds the offeringAtTo to the search attempts history params
func (o *SearchAttemptsHistoryParams) SetOfferingAtTo(offeringAtTo *string) {
...
// WithQ adds the q to the search attempts history params
func (o *SearchAttemptsHistoryParams) WithQ(q *string) *SearchAttemptsHistoryParams {
	o.SetQ(q)
	return o
}

// SetQ adds the q to the search attempts history params
func (o *SearchAttemptsHistoryParams) SetQ(q *string) {
	o.Q = q
}
...
// bindParamSearchAttemptsHistory binds the parameter result
func (o *SearchAttemptsHistoryParams) bindParamResult(formats strfmt.Registry) []string {
	resultIR := o.Result
