...
type CreateServiceParams struct {
	...
	// Body.
	Body *models.CasesCreateServiceRequest
...
func (o *CreateServiceParams) WithBody(body *models.CasesCreateServiceRequest) *CreateServiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create service params
func (o *CreateServiceParams) SetBody(body *models.CasesCreateServiceRequest) {
	o.Body = body
}
