...
func (o *UpdateServiceParams) WithInput(input *models.CasesInputService) *UpdateServiceParams {
	o.SetInput(input)
	return o
}

// SetInput adds the input to the update service params
func (o *UpdateServiceParams) SetInput(input *models.CasesInputService) {
	o.Input = input
}
