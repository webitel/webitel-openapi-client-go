...
// IsSuccess returns true when this update service Ok response has a 2xx status code
func (o *UpdateServiceOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update service Ok response has a 3xx status code
func (o *UpdateServiceOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update service Ok response has a 4xx status code
func (o *UpdateServiceOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this update service Ok response has a 5xx status code
func (o *UpdateServiceOK) IsServerError() bool {
	return false
}

// IsCode returns true when this update service Ok response a status code equal to that given
func (o *UpdateServiceOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the update service Ok response
...
func (o *UpdateServiceOK) Error() string {
	...
	return fmt.Sprintf("[PUT /cases/services/{id}][%d] updateServiceOk %s", 200, payload)
}
...
func (o *UpdateServiceOK) GetPayload() *models.CasesService {
	return o.Payload
}
...
func (o *UpdateServiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cases/services/{id}][%d] UpdateService default %s", o._statusCode, payload)
}
...
func (o *UpdateServiceDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}
