...
func (a *Client) ShiftTemplateServiceCreateShiftTemplateWithParams(params *ShiftTemplateServiceCreateShiftTemplateParams, opts ...ClientOption) (*ShiftTemplateServiceCreateShiftTemplateOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for ShiftTemplateService_CreateShiftTemplate: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ShiftTemplateServiceDeleteShiftTemplateWithParams(params *ShiftTemplateServiceDeleteShiftTemplateParams, opts ...ClientOption) (*ShiftTemplateServiceDeleteShiftTemplateOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ShiftTemplateService_DeleteShiftTemplate: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ShiftTemplateServiceReadShiftTemplate(params *ShiftTemplateServiceReadShiftTemplateParams, opts ...ClientOption) (*ShiftTemplateServiceReadShiftTemplateOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ShiftTemplateService_ReadShiftTemplate: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ShiftTemplateServiceSearchShiftTemplate(params *ShiftTemplateServiceSearchShiftTemplateParams, opts ...ClientOption) (*ShiftTemplateServiceSearchShiftTemplateOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ShiftTemplateService_SearchShiftTemplate: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ShiftTemplateServiceUpdateShiftTemplateWithParams(params *ShiftTemplateServiceUpdateShiftTemplateParams, opts ...ClientOption) (*ShiftTemplateServiceUpdateShiftTemplateOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ShiftTemplateService_UpdateShiftTemplate: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
