...
// WithID adds the id to the update status params
func (o *UpdateStatusParams) WithID(id string) *UpdateStatusParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update status params
func (o *UpdateStatusParams) SetID(id string) {
	o.ID = id
}

// WithInput adds the input to the update status params
func (o *UpdateStatusParams) WithInput(input *models.CasesInputStatus) *UpdateStatusParams {
	o.SetInput(input)
	return o
}

// SetInput adds the input to the update status params
func (o *UpdateStatusParams) SetInput(input *models.CasesInputStatus) {
	o.Input = input
}
