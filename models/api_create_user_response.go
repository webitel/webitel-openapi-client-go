...
//
// swagger:model api.CreateUserResponse
...
func (m *APICreateUserResponse) validateUser(formats strfmt.Registry) error {
...
// ContextValidate validate this api create user response based on the context it is used
...
func (m *APICreateUserResponse) contextValidateUser(ctx context.Context, formats strfmt.Registry) error {
