...
// APILDAPCatalog LDAPCatalog profile
//
// swagger:model api.LDAPCatalog
type APILDAPCatalog struct {
...
// Validate validates this api LDAP catalog
func (m *APILDAPCatalog) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APILDAPCatalog) validateCreatedBy(formats strfmt.Registry) error {
...
func (m *APILDAPCatalog) validateProcess(formats strfmt.Registry) error {
...
func (m *APILDAPCatalog) validateSync(formats strfmt.Registry) error {
...
func (m *APILDAPCatalog) validateTemplates(formats strfmt.Registry) error {
...
func (m *APILDAPCatalog) validateTLS(formats strfmt.Registry) error {
...
func (m *APILDAPCatalog) validateUpdatedBy(formats strfmt.Registry) error {
...
// ContextValidate validate this api LDAP catalog based on the context it is used
func (m *APILDAPCatalog) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *APILDAPCatalog) contextValidateCreatedBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APILDAPCatalog) contextValidateProcess(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APILDAPCatalog) contextValidateSync(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APILDAPCatalog) contextValidateTemplates(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APILDAPCatalog) contextValidateTLS(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APILDAPCatalog) contextValidateUpdatedBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APILDAPCatalog) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *APILDAPCatalog) UnmarshalBinary(b []byte) error {
	var res APILDAPCatalog
