...
// APILDAPLDAPSearchBody https://datatracker.ietf.org/doc/html/rfc4511#section-4.5.1
//
// swagger:model api.LDAP.LDAPSearchBody
type APILDAPLDAPSearchBody struct {
...
// Validate validates this api LDAP LDAP search body
func (m *APILDAPLDAPSearchBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APILDAPLDAPSearchBody) validateControls(formats strfmt.Registry) error {
...
func (m *APILDAPLDAPSearchBody) validateTLS(formats strfmt.Registry) error {
...
// ContextValidate validate this api LDAP LDAP search body based on the context it is used
func (m *APILDAPLDAPSearchBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *APILDAPLDAPSearchBody) contextValidateControls(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APILDAPLDAPSearchBody) contextValidateTLS(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APILDAPLDAPSearchBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *APILDAPLDAPSearchBody) UnmarshalBinary(b []byte) error {
	var res APILDAPLDAPSearchBody
