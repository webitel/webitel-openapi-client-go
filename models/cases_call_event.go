...
// CasesCallEvent cases call event
//
// swagger:model casesCallEvent
type CasesCallEvent struct {
	...
	// files
	Files []*CasesCallFile `json:"files"`

	// flow scheme
	FlowScheme *GeneralLookup `json:"flow_scheme,omitempty"`

	// gateway
	Gateway *GeneralLookup `json:"gateway,omitempty"`
	...
	// queue
	Queue *GeneralLookup `json:"queue,omitempty"`

	// total duration
	TotalDuration string `json:"total_duration,omitempty"`

	// transcripts
	Transcripts []*CasesTranscriptLookup `json:"transcripts"`
}

// Validate validates this cases call event
func (m *CasesCallEvent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CasesCallEvent) validateFiles(formats strfmt.Registry) error {
...
func (m *CasesCallEvent) validateFlowScheme(formats strfmt.Registry) error {
...
func (m *CasesCallEvent) validateGateway(formats strfmt.Registry) error {
...
func (m *CasesCallEvent) validateParticipants(formats strfmt.Registry) error {
...
func (m *CasesCallEvent) validateQueue(formats strfmt.Registry) error {
...
func (m *CasesCallEvent) validateTranscripts(formats strfmt.Registry) error {
...
// ContextValidate validate this cases call event based on the context it is used
func (m *CasesCallEvent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CasesCallEvent) contextValidateFiles(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CasesCallEvent) contextValidateFlowScheme(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CasesCallEvent) contextValidateGateway(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CasesCallEvent) contextValidateParticipants(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CasesCallEvent) contextValidateQueue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CasesCallEvent) contextValidateTranscripts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CasesCallEvent) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CasesCallEvent) UnmarshalBinary(b []byte) error {
	var res CasesCallEvent
