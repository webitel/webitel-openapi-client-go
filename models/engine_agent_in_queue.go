...
type EngineAgentInQueue struct {
	...
	// agents
	Agents *AgentInQueueAgentsInQueue `json:"agents,omitempty"`
...
func (m *EngineAgentInQueue) validateAgents(formats strfmt.Registry) error {
...
func (m *EngineAgentInQueue) contextValidateAgents(ctx context.Context, formats strfmt.Registry) error {
