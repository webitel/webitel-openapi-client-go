...
func (m *EngineCalendar) validateSpecials(formats strfmt.Registry) error {
...
func (m *EngineCalendar) contextValidateSpecials(ctx context.Context, formats strfmt.Registry) error {
