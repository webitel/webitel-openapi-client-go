...
// EnginePatchMemberOneRequest engine patch member one request
//
// swagger:model enginePatchMemberOneRequest
type EnginePatchMemberOneRequest struct {
...
// Validate validates this engine patch member one request
func (m *EnginePatchMemberOneRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EnginePatchMemberOneRequest) validateAgent(formats strfmt.Registry) error {
...
func (m *EnginePatchMemberOneRequest) validateBucket(formats strfmt.Registry) error {
...
func (m *EnginePatchMemberOneRequest) validateCommunications(formats strfmt.Registry) error {
...
func (m *EnginePatchMemberOneRequest) validateSkill(formats strfmt.Registry) error {
...
func (m *EnginePatchMemberOneRequest) validateTimezone(formats strfmt.Registry) error {
...
// ContextValidate validate this engine patch member one request based on the context it is used
func (m *EnginePatchMemberOneRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *EnginePatchMemberOneRequest) contextValidateAgent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EnginePatchMemberOneRequest) contextValidateBucket(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EnginePatchMemberOneRequest) contextValidateCommunications(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EnginePatchMemberOneRequest) contextValidateSkill(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EnginePatchMemberOneRequest) contextValidateTimezone(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EnginePatchMemberOneRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EnginePatchMemberOneRequest) UnmarshalBinary(b []byte) error {
	var res EnginePatchMemberOneRequest
