...
func (m *EngineUpdateAgentTeamRequest) validateForecastCalculation(formats strfmt.Registry) error {
...
func (m *EngineUpdateAgentTeamRequest) contextValidateForecastCalculation(ctx context.Context, formats strfmt.Registry) error {
