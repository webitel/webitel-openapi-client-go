...
func (m *EngineUpdateCommunicationTypeRequest) validateChannel(formats strfmt.Registry) error {
...
// ContextValidate validate this engine update communication type request based on the context it is used
...
func (m *EngineUpdateCommunicationTypeRequest) contextValidateChannel(ctx context.Context, formats strfmt.Registry) error {
