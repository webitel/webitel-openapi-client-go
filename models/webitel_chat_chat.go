...
// WebitelChatChat The Chat info.
// Alias: participant, subscriber, member, peer, leg.
//
// swagger:model webitel.chat.Chat
type WebitelChatChat struct {
	...
	Invite *WebitelChatChatInvite `json:"invite,omitempty"`
	...
	Peer *WebitelChatPeer `json:"peer,omitempty"`
...
// Validate validates this webitel chat chat
func (m *WebitelChatChat) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *WebitelChatChat) validateInvite(formats strfmt.Registry) error {
...
func (m *WebitelChatChat) validatePeer(formats strfmt.Registry) error {
...
func (m *WebitelChatChat) validateQueue(formats strfmt.Registry) error {
...
func (m *WebitelChatChat) validateVia(formats strfmt.Registry) error {
...
// ContextValidate validate this webitel chat chat based on the context it is used
func (m *WebitelChatChat) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *WebitelChatChat) contextValidateInvite(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebitelChatChat) contextValidatePeer(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebitelChatChat) contextValidateQueue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebitelChatChat) contextValidateVia(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebitelChatChat) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *WebitelChatChat) UnmarshalBinary(b []byte) error {
	var res WebitelChatChat
